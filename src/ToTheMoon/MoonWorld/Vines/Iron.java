...
public class Iron extends BlockPopulator {
	...
	public void populate(World world, Random r, Chunk chunk) {
		...
		for (int i = 1; i < 15; i++) {
			if (r.nextInt(100) < this.fileConfig.getInt("ToTheMoon.WorldGeneration.IronSpawnPercentage")) {
				int X = r.nextInt(15);
				int Z = r.nextInt(15);
 ...
 * Vines\Iron.class Java compiler version: 7 (51.0) JD-Core Version: 1.1.3
 */